...
# Usage : MOE_db_ROC_analysis.py [filename.txt] ([NB_COMPOUNDS] [NB_ACTIVE_COMPOUNDS])
# If not given, NB_COMPOUND = 100 and NB_ACTIVE_COMPOUNDS = 10
...
ef10 = (tp[9]/10)/(NB_POSITIVE/NB_COMPOUNDS)

plt.xlabel('False positive rate')
plt.ylabel('True positive rate')
plt.title('ROC curve (AOC = {:.2f}, EF10 = {:.2f})'.format(aoc,ef10))
plt.plot(fpr,tpr)
